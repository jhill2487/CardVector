...
shutil.copy2(MANIFEST, archive / f"manifest_before_v0_8_3a_{stamp}.json")

builder = TOOLS / "build_coverage_analytics_v0_8_3.py"
...
manifest["version"] = "0.8.3.1"
MANIFEST.write_text(json.dumps(manifest, indent=2), encoding="utf-8")

print("Installed v0.8.3A Coverage Analytics Fix")
print(f"Extension version: {old_version} -> 0.8.3.1")

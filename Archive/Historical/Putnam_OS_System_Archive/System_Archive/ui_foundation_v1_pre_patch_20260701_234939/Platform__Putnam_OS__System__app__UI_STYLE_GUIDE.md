...
CardVector OS v1.2.1 carries forward the UI lock for the active Tkinter app.
...
v1.2.1 style uses flat, padded buttons with hover states and consistent colors

...
CardVector OS v1.1.0 carries forward the UI lock for the active Tkinter app.
...
v1.1.0 style uses flat, padded buttons with hover states and consistent colors

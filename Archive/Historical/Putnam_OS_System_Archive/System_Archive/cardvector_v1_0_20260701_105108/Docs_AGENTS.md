...
This handbook implements the Putnam Platform Standards, which implement the
Putnam Principles.

## Project Vision

Putnam Collectibles is a unified trading card operations platform.
...
The primary purpose of Putnam OS is to help Putnam Collectibles generate cash
flow.
...
Putnam OS is developed to remove operational bottlenecks discovered while
running the business.

The business identifies problems.

Putnam OS solves them.

...
for p in [OS_DIR, SYSTEM, APP_DIR, CONFIG, LOGS, CACHE, DATA, INCOMING, COMPLETED, SESSIONS,
...
class PutnamOS(BaseTk):
    ...
    def home_page(self):
        ...
        self.make_drop_zone(wrap, "ANALYZE CARDUPLOADER CSV", self.browse_and_run)

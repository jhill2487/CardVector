...
class PublicStorefrontContractTests(unittest.TestCase):
    ...
    def test_carduploader_referral_section_is_public_and_disclosed(self):
        ...
        self.assertIn("carduploader-brand-card", self.source_html)
        self.assertIn("AI listing workflow", self.source_html)
        self.assertIn("01 Upload", self.source_html)
        self.assertIn("02 Identify", self.source_html)
        self.assertIn("03 List", self.source_html)
        ...
        self.assertIn(".carduploader-brand-card", self.source_css)
        self.assertIn(".carduploader-flow", self.source_css)
        ...
        self.assertIn("AI listing workflow", self.output_html)
    ...
    def test_misprint_is_presented_as_selling_platform_referral(self):
        ...
        self.assertIn("misprint-brand-card", self.source_html)
        self.assertIn("Transparent Card Market", self.source_html)
        self.assertIn("misprint-button", self.source_html)
        self.assertIn(".selling-platform-section", self.source_css)
        self.assertIn(".misprint-brand-card", self.source_css)
        self.assertIn(".misprint-market-strip", self.source_css)
        self.assertIn(".misprint-button", self.source_css)
        ...
        self.assertIn("Transparent Card Market", self.output_html)

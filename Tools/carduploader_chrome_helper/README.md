...
version 0.3.9 is the non-destructive pagination Next control used by **Scan All
...
created. Version 0.3.9 also falls back to eBay on the CardUploader Automatic

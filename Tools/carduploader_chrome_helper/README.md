...
version 0.3.5 is the non-destructive pagination Next control used by **Scan All
...
created. Version 0.3.5 also falls back to eBay on the CardUploader Automatic

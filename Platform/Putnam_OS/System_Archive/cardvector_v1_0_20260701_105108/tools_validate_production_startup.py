...
def main() -> int:
    ...
    checks.append(("Compile Putnam OS Python", bool(compile_ok), str(PUTNAM_OS)))
    ...
    lines = [
        "Putnam OS v4.0.0 - UI Polish + UI Lock",
    ...
    print(f"Putnam OS v4.0.0 - UI Polish + UI Lock")

...
class PutnamOS(BaseTk):
        ...
        for section, names in nav_sections:
            ...
            for name in names:
                b = tk.Button(
                    ...
                    font=("Segoe UI", 10, "bold"), padx=24, pady=9, command=lambda n=name: self.show_page(n)
                )
    ...
    def home_page(self):
        ...
        tk.Button(latest_buttons, text="Analyze Latest Export", bg=BRAND["blue"], fg="white",
    ...
    def import_page(self):
        ...
        tk.Button(
            ...
            padx=18,
            pady=11,
            command=self.import_carduploader_csv_ui,
        ).pack(side="left")
    ...
    def capture_page(self):
        ...
        tk.Button(row1, text="Capture Next Photo", bg=BRAND["blue"], fg="white",
                  activebackground=BRAND["blue2"], relief="flat", font=("Segoe UI", 10, "bold"),
                  padx=14, pady=8, command=self.capture_next_photo_ui).pack(side="left", padx=8)
    ...
    def inventory_location_registry_panel(self, wrap):
        ...
        tk.Button(
            ...
            padx=14,
            pady=8,
            command=self.inventory_create_next_etb,
        ).pack(side="left")
...
if __name__ == "__main__":
    print(f"{APP_NAME} v{APP_VERSION} - Guided Workflow UX Update")

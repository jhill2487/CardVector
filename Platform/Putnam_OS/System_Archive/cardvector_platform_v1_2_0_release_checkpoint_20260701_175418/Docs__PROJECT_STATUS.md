...
Production workflow validation for CardVector Platform v1.2.0
...
- Simple ETB Location System
- Platform Path Manager v1.0
- CardVector Capture Studio v2 production workflow
- CardVector Capture Studio v2.1 Auto Capture

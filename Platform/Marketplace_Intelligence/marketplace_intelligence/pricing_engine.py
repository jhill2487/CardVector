...
class PricingEngine:
    ...
    def recommend(self, listing: Listing, market: MarketPrice) -> PriceRecommendation:
        ...
        shipping_adjusted_market = self.apply_shipping_assumption(market.market_price)
        ...
        if abs(difference) < ignore:
            ...
            reason = (
                f"Market ${market.market_price}; "
                f"{self.shipping_reason(market.market_price, shipping_adjusted_market)}; "

...
(function () {
  ...
  const siteLinks = Object.freeze({
    ...
    MANAPOOL_STORE_URL: "{{MANAPOOL_STORE_URL}}",
    CARDUPLOADER_STORE_URL: "{{CARDUPLOADER_STORE_URL}}",
    CARDUPLOADER_BUYLIST_URL: "{{CARDUPLOADER_BUYLIST_URL}}",
    CARDUPLOADER_REFERRAL_URL: "{{CARDUPLOADER_REFERRAL_URL}}",
